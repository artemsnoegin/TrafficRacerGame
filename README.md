...
Traffic Racer Game — этот проект, представляет собой аркадную игру для iOS. Игрок управляет машинкой, которая движется по дороге, уворачиваясь от машин движущихся на встречу. Машинки противнков и игрока генируруются случайным образом.
